var JSConfetti = function() {
    ...
    var h = function() {
        function e(i) {
            ...
            this.finalConfettiSpeedX = s(.2, .6, 3),
            this.rotationSpeed = u.length ? .01 : s(.03, .07, 3) * r(d),
            ...
            this.rotationAngle = "left" === a ? s(0, .2, 3) : s(-.2, 0, 3),
            this.emojiSize = l,
        ...
        return i(e, [{
            ...
            value: function(t) {
                ...
                t.fill()) : s && (t.font = "".concat(r, "px serif"),
                t.save(),
            ...
            value: function(t, e) {
                ...
                this.currentPosition.y = this.initialPosition.y - i.y * this.absSin * c + .00125 * Math.pow(c, 2) / 2,
                this.rotationSpeed -= this.emoji ? 1e-4 : 1e-5 * t,
                this.rotationSpeed < 0 && (this.rotationSpeed = 0),
                this.emoji ? this.emojiRotationAngle += this.rotationSpeed * t % (2 * Math.PI) : "down" === o ? (this.radius.y -= t * a,
    ...
    function u(t) {
        var e = t.confettiRadius
          ...
          , u = t.emojiSize
          , l = void 0 === u ? 80 : u;
        return t.emojies && console.error("emojies argument is deprecated, please use emojis instead"),
    ...
    var l = function() {
        ...
        return i(e, [{
            ...
            value: function() {
                var t;
                return !this.shapes.length && (null === (t = this.resolvePromise) || void 0 === t || t.call(this),
                !0)
            }
        }, {
            key: "processShapes",
    ...
    return function() {
        ...
        return i(e, [{
            ...
            value: function() {
                ...
                return this.activeConfettiBatches.push(p),
